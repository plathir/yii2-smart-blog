...
use plathir\smartblog\common\widgets\StaticPagesWidget;
...
<div class="smartblog-default-index">
    <div class="box box-danger">
        ...
        <div class="box-body">
            ...
            <?= Html::a(Yii::t('app', '<i class="fa fa-wrench"></i>Index with position Loading widgets'), ['/blog/default/index1'], ['class' => 'btn btn-app']) ?>
        </div>
    </div>
    <?=
    StaticPagesWidget::widget([
        'page_id' => 1
    ]);
    ?>
